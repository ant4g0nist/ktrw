...
kextload_patch() {
	...
	xnu_pf_maskmatch(patchset, "ktrr_mmu", ktrr_mmu_match, ktrr_mmu_mask, ktrr_mmu_count,
			true, ktrr_mmu_patch);
	...
	xnu_pf_maskmatch(patchset, "ktrr_amcc", ktrr_amcc_match, ktrr_amcc_mask, ktrr_amcc_count,
	...
	xnu_pf_maskmatch(patchset, "oskext_init", OSKext_init_match, OSKext_init_mask, OSKext_init_count,
